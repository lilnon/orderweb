                ...
                <?php while($row = $result->fetch_assoc()): ?>
                    <div class="bg-white shadow-md rounded-lg overflow-hidden">
                        ...
                        <div class="p-4">
                            ...
                            <p class="text-gray-800 font-bold mb-4"><?php echo htmlspecialchars($row['price']); ?> บาท</p>
            ...
            <div class="bg-white p-8 rounded-lg shadow-lg w-3/4 max-w-lg">
                ...
                <ul id="orderSummaryList" class="mb-4">
                    <?php if (!empty($_SESSION['order'])): ?>
                        ...
                        ?>
                            <li class="mb-2">
                                <?php echo htmlspecialchars($item['name']); ?> - Quantity: <?php echo htmlspecialchars($item['quantity']); ?> - <?php echo htmlspecialchars($item_total); ?> บาท
                            </li>
                        <?php endforeach; ?>
                        <li class="font-bold mt-4">Total: <?php echo htmlspecialchars($total); ?> บาท</li>
                    <?php else: ?>
